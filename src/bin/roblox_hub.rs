        ...
        .map(|task_id| {
            if let Some(task) = helper.active_tasks.get(task_id) {
                HelperActiveTaskPayload {
                    ...
                    last_known_session_state: task.last_known_session_state.clone(),
                    last_session_error_reason: task.last_session_error_reason.clone(),
                    ...
                    active_stop_request_id: task.active_stop_request_id,
                    last_stop_request_id: task.last_stop_request_id,
                    stop_request_recorded_age_ms: task
                    ...
                    runtime_actuator_last_poll_age_ms: task
                        ...
                        .map(|age| age + age_delta),
                    stop_result_phase: task.stop_result_phase.clone(),
                    stop_result_age_ms: task.stop_result_age_ms.map(|age| age + age_delta),
                    stop_result_error: task.stop_result_error.clone(),
    ...
    for active_task in payload.active_tasks {
        ...
        helper.active_tasks.insert(
            ...
            HelperActiveTaskRecord {
                ...
                last_known_session_state: active_task.last_known_session_state,
                last_session_error_reason: active_task.last_session_error_reason,
                ...
                active_stop_request_id: active_task.active_stop_request_id,
                last_stop_request_id: active_task.last_stop_request_id,
                stop_request_recorded_age_ms: active_task.stop_request_recorded_age_ms,
                ...
                stop_result_phase: active_task.stop_result_phase,
                stop_result_age_ms: active_task.stop_result_age_ms,
                stop_result_error: active_task.stop_result_error,
        ...
        let response = helper_heartbeat_handler(
            ...
            Json(HelperHeartbeatRequest {
                ...
                active_tasks: vec![HelperActiveTaskHeartbeat {
                    ...
                    studio_control_last_error: None,
                    active_stop_request_id: Some(3),
                    last_stop_request_id: Some(3),
                    stop_request_recorded_age_ms: Some(12),
                    runtime_actuator_last_poll_id: Some(3),
                    runtime_actuator_last_poll_age_ms: Some(8),
                    stop_result_phase: Some("observed".to_owned()),
                    stop_result_age_ms: Some(4),
                    stop_result_error: None,
