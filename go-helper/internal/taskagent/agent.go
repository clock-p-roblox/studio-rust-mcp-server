...
func (a *Agent) Run(ctx context.Context) error {
	...
	taskSessionToken, err := NewTaskSessionToken()
	if err != nil {
		_ = listener.Close()
		return err
	}
...
func (a *Agent) Status() StatusResponse {
	...
	return StatusResponse{
		...
		CodeSync:                 a.descriptor.CodeSync,
	}
}
...
func (a *Agent) sendHeartbeat() {
	body := map[string]any{
		...
		"task_session_token":       a.descriptor.TaskSessionToken,
...
func (a *Agent) releaseHelper() {
	...
	req.Header.Set("Content-Type", "application/json")
	req.Header.Set("X-ClockP-Task-Token", a.descriptor.TaskSessionToken)
