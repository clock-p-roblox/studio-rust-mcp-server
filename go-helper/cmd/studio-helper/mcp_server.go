...
func mcpTools() []map[string]any {
	return []map[string]any{
		...
		mcpTool("helper2_studio_play", "Low-level bridge play primitive: enqueue Studio play and return request acceptance only; normal launch callers should use bridge play and verify mode_seq plus launch_id.", map[string]any{
